        ...
        <div className="min-h-screen pb-24 overflow-x-hidden bg-[#F8FAFC] dark:bg-black transition-colors duration-300">
            ...
            {selectedContent && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-md" onClick={() => setSelectedContent(null)}>
                    ...
                    >
                        <div className="relative w-full h-48 bg-gradient-to-br from-emerald-100 to-teal-100 dark:from-emerald-900/40 dark:to-teal-900/40 shrink-0">
                            ...
                            <div className="absolute bottom-4 left-6">
                                <span className="bg-emerald-600 text-white text-[10px] font-black uppercase px-4 py-1.5 rounded-full shadow-lg">Mengatur Keuangan</span>
                            </div>
                        </div>
