            ...
            {!selectedContent ? (
                ...
                <div className="animate-[slideUp_0.35s_ease-out] w-full bg-white dark:bg-zinc-950 flex flex-col">
                    ...
                    <div className="sticky top-0 z-30 flex items-center justify-between px-6 py-4 bg-white/90 dark:bg-zinc-950/90 backdrop-blur-xl border-b border-slate-100 dark:border-white/5">
                        <button onClick={() => setSelectedContent(null)} className="flex items-center gap-2 text-sm font-bold text-slate-500 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors bg-transparent border-none cursor-pointer">
                            <FiX size={20} /> Tutup Artikel
                        </button>
                        <span className="bg-blue-600 text-white text-[10px] font-black uppercase px-4 py-1.5 rounded-full shadow-sm">Memulai Usaha</span>
                    </div>
                    ...
                    {selectedContent.gambar ? (
                        ...
                        <div className="w-full h-48 bg-gradient-to-br from-blue-100 to-indigo-100 dark:from-blue-900/40 dark:to-indigo-900/40 flex items-center justify-center text-6xl opacity-30">
                            🚀
                        </div>
                    )}
